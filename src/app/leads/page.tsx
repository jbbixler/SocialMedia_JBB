...
function buildLinks(lead: Lead) {
  ...
  return [
    ...
    },
    {
      ...
      url: `https://www.linkedin.com/search/results/people/?keywords=${encodeURIComponent(lead.name + ' ' + lead.company)}`,
    },
    {
      label: 'Website',
      icon: (
    ...
    },
    {
      ...
      url: `https://www.facebook.com/ads/library/?active_status=all&ad_type=all&country=US&q=${encodeURIComponent(lead.company)}&search_type=keyword_unordered`,
    },
  ]
}
